...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Сроки зависят от типа и площади объекта. Строительство инженерных систем под ключ обычно занимает от 6 до 12 месяцев. Точные сроки мы фиксируем в договоре после составления проекта и сметы.",
  },
  {
