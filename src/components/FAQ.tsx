...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Мы выполняем полный цикл: проектирование, фундамент, возведение коробки, кровлю, инженерные сети, черновую и чистовую отделку, а также благоустройство территории.",
  },
  {
