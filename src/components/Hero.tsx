  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/cd4c18b9-9795-44de-9cec-67cabfca1225/files/b5eec0d0-3aa9-41df-82a7-72a4eec368ac.jpg"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">
            {c(content, "hero_subtitle", "Строительная компания МКМ-НН")}
          </p>
          <h1 ref={titleRef} className="text-7xl font-medium text-balance text-center text-white mb-0 tracking-tight leading-[0.9] lg:text-8xl">
            {c(content, "hero_title_line1", "Строим объекты")}
            <br />
            <span className="text-orange-200">{c(content, "hero_title_line2", "на совесть")}</span>
          </h1>
        </div>
      </div>
